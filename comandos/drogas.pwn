...
GREENSIDE::ShowPlayerDrugs(playerid, offset)
{
...
GREENSIDE::ShowCombineDrugs(playerid, offset)
{
	format(gstr, sizeof(gstr), "Drug Name\tAmount\n");
	DrugSelectionOffset[playerid] = offset;
	for(new r = 0; r < cache_get_row_count(conn); r++)
...
GREENSIDE::ShowIngredients(playerid, offset)
{
...
GREENSIDE::GivePlayerDrugs(playerid, offset)
{
	format(gstr, sizeof(gstr), "Drug Name\tAmount\n");
	DrugSelectionOffset[playerid] = offset;
	for(new r = 0; r < cache_get_row_count(conn); r++)
...
GREENSIDE::GivePlayerIngreds(playerid, offset)
{
	format(gstr, sizeof(gstr), "Ingredient Name\tAmount\n");
	DrugSelectionOffset[playerid] = offset;
	for(new r = 0; r < cache_get_row_count(conn); r++)
...
GREENSIDE::GivePlayerDrug(playerid, drugAmount)
{
...
GREENSIDE::GivePlayerIngred(playerid, iAmount)
{
...
GREENSIDE::SelectIngredients(playerid)
{
...
GREENSIDE::SelectPlayerDrug(playerid)
{
	DrugSelectionOffset[playerid] = cache_get_field_content_int(0, "id");
...
GREENSIDE::SelectCombineDrug(playerid)
{
	if(cache_num_rows() == 1)
	{
...
GREENSIDE::DropIngredients(playerid, amount)
{
...
GREENSIDE::DroppingDrugs(playerid, amount)
{
...
GREENSIDE::PickupDrug(playerid, d)
{
	if(cache_num_rows() > 0)
	{
...
GREENSIDE::PickupIngredient(playerid, d)
{
	if(cache_num_rows() > 0)
	{
...
GREENSIDE::PickupTestIngredient(playerid, type)
{
	if(cache_num_rows() > 0)
	{
...
GREENSIDE::DoingDrugsMate(playerid)
{
	for(new p = 1; p < MAX_DRUGS; p++)
	{
		if(DrugTakenData[p][effActive] == 0)
...
GREENSIDE::RedoingDrugsMate(playerid, d)
{
...
GREENSIDE::RetrieveIngInfo(playerid, offset)
{
...
GREENSIDE::CombineDrug(playerid)
{
	for(new i=0; i<3; i++)
	{
...
GREENSIDE::ExplosionTimer(playerid)
{
